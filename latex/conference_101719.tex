...
\begin{figure}[H]
    ...
    \begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{Picture/RF/Cruide_Oil_73.png} 
    ...
    \begin{minipage}{0.3\textwidth} 
    \centering
    \includegraphics[width=0.8\textwidth]{Picture/RF/Gasoline_RBOB_73.png}
    ...
    \begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{Picture/RF/Heating_Oil_73.png}
